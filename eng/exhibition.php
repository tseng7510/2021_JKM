  ...
  <div class="wrapper insidePages newsList">
    ...
    <main class="siteMain" aria-label="main" itemscope>
      ...
      <div class="inBanner">
        ...
        <div class="pageTitleBox">
          <div class="titleBox wow fadeInUp" data-wow-delay="0s">
            <h1 class="title">Exhibition<br />Information</h1>
            <div class="slogan">Check all the latest news and Exhibition</div>
          </div>
        </div>
      </div>
      ...
      <div class="mainBox">
        <section>
          <div class="container">
            <h2 class="pageTitle"><span>OUR</span> EXHIBITION</h2>

            <div class="contentBox">
              <div class="listBox">

                <?php for ($i = 0; $i < 7; $i++) { ?>
                  <div class="item wow fadeInUp" data-wow-delay="0s" data-type="Exhibition">
